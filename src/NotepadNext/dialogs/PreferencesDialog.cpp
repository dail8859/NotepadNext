    ...
    settings(settings)
{
    ...
    MapSettingToCheckBox(ui->checkBoxSearchDialogLock, &ApplicationSettings::centerSearchDialog, &ApplicationSettings::setCenterSearchDialog, &ApplicationSettings::showStatusBarChanged);
