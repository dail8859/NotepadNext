...
CREATE_SETTING(Editor, AutoInsertParentheses, autoInsertParentheses, bool, false)
CREATE_SETTING(Editor, AutoInsertSquareBrackets, autoInsertSquareBrackets, bool, false)
CREATE_SETTING(Editor, AutoInsertCurlyBraces, autoInsertCurlyBraces, bool, false)
CREATE_SETTING(Editor, AutoInsertSingleQuotes, autoInsertSingleQuotes, bool, false)
CREATE_SETTING(Editor, AutoInsertDoubleQuotes, autoInsertDoubleQuotes, bool, false)
CREATE_SETTING(Editor, AutoInsertHtmlTags, autoInsertHtmlTags, bool, true)
